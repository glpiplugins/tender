...
CREATE TABLE `glpi_plugin_tender_offers` (
            `id` int unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `glpi_plugin_tender_tenderitems` (
            ...
            `net_price` int signed NOT NULL DEFAULT '0',
...
CREATE TABLE `glpi_plugin_tender_distributions` (
            ...
            `quantity` int unsigned DEFAULT NULL,
            `percentage` int signed DEFAULT '10000',
...
CREATE TABLE `glpi_plugin_tender_offeritems` (
            `id` int unsigned NOT NULL AUTO_INCREMENT,
            `plugin_tender_offers_id` int unsigned DEFAULT NULL,
            `plugin_tender_tenderitems_id` int unsigned DEFAULT NULL,
            `net_price` int signed NOT NULL DEFAULT '0',
            `tax` int unsigned DEFAULT NULL,
            `date_mod` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `glpi_plugin_tender_tendertypes` (
            `id` int unsigned NOT NULL AUTO_INCREMENT,
            `name` VARCHAR(255) DEFAULT NULL,
            `min_value` int signed NOT NULL DEFAULT '0',
            `max_value` int signed NOT NULL DEFAULT '0',
            `date_mod` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
            `date_creation` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
            PRIMARY KEY (`id`),
            KEY `name` (`name`),
