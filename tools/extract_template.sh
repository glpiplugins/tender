...
xgettext *.php */*.php --copyright-holder='Roy Brannath' --package-name='GLPI - Tender Plugin' --package-version='1.0.3' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
